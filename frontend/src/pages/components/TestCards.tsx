...
const Testcards = ({ image, name, details }: Props) => {
  return (
    <div className="p-6 m-4 bg-[#592CA1] h-[80vh] sm:h-[60vh] md:h-[75vh] lg:h-[70vh] overflow-hidden flex flex-col justify-around 300px:h-[70vh] 400px:h-[55vh]">
      ...
      <p className="mt-4 text-white text-pretty text-sm md:text-base">
        {details}
      </p>
